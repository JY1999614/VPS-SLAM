...
public:
    ...
    {
        nh.param<double>("noise_model/acc_cov", acc_cov, 0.0005);
        nh.param<double>("noise_model/gyr_cov", gyr_cov, 0.00005);
        nh.param<double>("noise_model/b_acc_cov", b_acc_cov, 0.00001);
        nh.param<double>("noise_model/b_gyr_cov", b_gyr_cov, 0.000001);
        g_vec = gravity;
    ...
    void propagate(double _dt, const Eigen::Vector3d &_acc_1, const Eigen::Vector3d &_gyr_1)
    {
        ...
        midPointIntegration(_dt, acc_0, gyr_0, _acc_1, _gyr_1, delta_p, delta_q, delta_v,
                            ...
                            result_delta_v, result_linearized_ba, result_linearized_bg);
    ...
    double sum_dt;
    Eigen::Vector3d delta_p, corrected_delta_p;
    Eigen::Quaterniond delta_q, corrected_delta_q, residual_q;
    Eigen::Vector3d delta_v, corrected_delta_v;
